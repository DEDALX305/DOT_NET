...
namespace MainProject
{
    ...
    class PersonMain
    {
        ...
        public void Person(string name, int password)
        {
            this.Name = name;
    ...
    class PersonBinary : PersonMain
    {
        private string v1;
        private int v2;

        public PersonBinary(string v1, int v2)
        {
            this.v1 = v1;
            this.v2 = v2;
        }
    ...
    class PersonJson : PersonMain
    {
        ...
        public PersonJson(string v1, int v2)
        {
            this.v1 = v1;
            this.v2 = v2;
        }
     ...
     class PersonXML : PersonMain
    {
        private string v1;
        private int v2;

        public PersonXML(string v1, int v2)
        {
            this.v1 = v1;
            this.v2 = v2;
        }
